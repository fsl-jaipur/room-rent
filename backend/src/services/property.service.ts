import { createProperty, editProperty, getPropertyById, getPropertyMeta, listProperties, softDeleteProperty } from "../db";
import type { PropertyInput } from "../shared/schema";
